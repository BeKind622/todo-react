...
async function addPhoto(id, imgSrc) { // 4 → To save a photo, the id will be passed as propconsole.log("addPhoto", imgSrc.length, id);
 try {
 ...
 id: id, // 5 → Create & stored an object with both an indexed id
